        ...
        <div class="container" style="padding-top:5%">
            <div class="row">
                ...
                <center><h1>My events</h1><br>
                   <button class="btn btn-primary" onClick="location.href='manageMyEvent.php'">My events</button><br><br>
                    <button class="btn btn-info" onClick="location.href='hostEvent.php'">Host an event</button><br><br>
                    <button class="btn btn-success" onClick="location.href='bookForEvent.php'"> Book for an Event</button><br><br>
                    <button class="btn btn-danger" onClick="location.href='deleteTicket.php'"> Delete an booked Event</button></center><br>
                </div>
                <div class="col-sm">
                   <center> <h1>My Upcoming Events</h1> <br><br>
                        <?php
